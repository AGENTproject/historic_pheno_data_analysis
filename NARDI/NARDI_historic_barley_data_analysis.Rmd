---
title: An R Markdown document converted from "NARDI_historic_barley_data_analysis.ipynb"
output: html_document
---

# NARDI historical phenotypic barley data analysis
origin and version of the input files: 
- https://urgi.versailles.inrae.fr/fairdom/data_files/490?version=2
- https://urgi.versailles.inrae.fr/fairdom/data_files/398?version=4
...
```{r}
data_total_spring <- preprocess("NARDI_Phenotypic_Historical_Spring_Barley_18jan.xlsx")
...
write_csv(data_corrected_all, "NARDI_winter_barley_corrected.csv")
```
...
data_corrected_all <- bind_rows(
    ...
    data_corrected_SB_TKW_II,
         ...
         drop_na() |> arrange(campaign, accenumb, trait)
write_csv(data_corrected_all, "NARDI_spring_barley_corrected.csv")
```
