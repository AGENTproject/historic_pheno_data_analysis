---
title: An R Markdown document converted from "WBF-Agroscope_historic_spelt_data_analysis.ipynb"
output: html_document
---

# Agroscope historical phenotypic spelt data analysis
origin and version of the input file: https://urgi.versailles.inrae.fr/fairdom/data_files/58?version=13
...
```{r}
data_total <- preprocess("Spelt_hist_v6-1-1.xlsx", obs_col_types = c('numeric', rep('text', 5), rep('numeric', 8)))
