---
title: An R Markdown document converted from "ICARDA_historic_wheat_data_analysis.ipynb"
output: html_document
---

# ICARDA historical phenotypic wheat data analysis
origin and version of the input file: https://urgi.versailles.inrae.fr/fairdom/data_files/333?version=4
...
library(multtest)
library(asreml)
asreml.options(threads=8, workspace="20gb")
...
```{r}
data_sub_HT <- data_sub_HT |> remove_lonely(2) # debug asreml
...
write_csv(data_corrected_all, "ICARDA_wheat_corrected.csv")
```
